...
const TRAILS = [
  ...
  // Stuart Island
  { id: "turn-point-lighthouse", name: "Turn Point Lighthouse Trail", island: null, area: "Stuart Island", lat: 48.682, lng: -123.236, difficulty: "Easy/Moderate", distance: "3.5 mi round trip", elevGain: "Minimal", description: "From Reid Harbor or Prevost Harbor to the 1893 Turn Point Lighthouse at the island's western tip. Views into Canadian waters.", discoverPass: false },

  // Patos Island
  { id: "patos-loop", name: "Patos Island Loop", island: null, area: "Patos Island", lat: 48.787, lng: -122.972, difficulty: "Easy", distance: "1.5 mi loop", elevGain: "Minimal", description: "Loop trail through madrone forest to the 1893 lighthouse at the western point. Tended by volunteer Keepers of the Patos Light.", discoverPass: false, seasonalNotes: "Lighthouse open summer weekends only" },

  // Cypress Island
  { id: "eagle-cliff", name: "Eagle Cliff Trail", island: null, area: "Cypress Island", lat: 48.581, lng: -122.694, difficulty: "Moderate-Strenuous", distance: "3 mi round trip", elevGain: "750 ft", description: "Summit climb to a 750-foot viewpoint overlooking Rosario Strait and the San Juan archipelago. DNR-managed.", discoverPass: false, seasonalNotes: "CLOSED Feb 1 - Jul 15 for raptor nesting" },
