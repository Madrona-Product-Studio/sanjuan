...
const GALLERIES = [
  { id: "arctic-raven", name: "Arctic Raven Gallery", island: "san-juan", area: "Friday Harbor", lat: 48.5347, lng: -123.0166, walkFromDock: "0.1 mi", type: "gallery", description: "Northwest Coast Native art — masks, carvings, prints from Coast Salish, Haida, and Tlingit nations. 130 First Street S." },
  { id: "waterworks", name: "WaterWorks Gallery", island: "san-juan", area: "Friday Harbor", lat: 48.5352, lng: -123.0179, walkFromDock: "0.2 mi", type: "gallery", description: "Contemporary Pacific Northwest artists since 1985." },
  { id: "island-studios", name: "Island Studios", island: "san-juan", area: "Friday Harbor", lat: 48.534, lng: -123.019, walkFromDock: "0.3 mi", type: "gallery", description: "Exclusively represents artists living in the San Juans. 270 Spring Street." },
  { id: "sji-museum-art", name: "San Juan Islands Museum of Art", island: "san-juan", area: "Friday Harbor", lat: 48.533, lng: -123.021, walkFromDock: "0.3 mi", type: "museum", description: "Rotating exhibitions Fri-Mon 11AM-5PM. Administers the Sculpture Park near Roche Harbor. 540 Spring Street." },
  { id: "sculpture-park", name: "San Juan Islands Sculpture Park", island: "san-juan", area: "Roche Harbor", lat: 48.606, lng: -123.152, walkFromDock: "Near Roche Harbor", type: "sculpture_park", description: "Free 20-acre outdoor park with 150 sculptures across 5 trails. Open dawn to dusk year-round." },
  { id: "orcas-pottery", name: "Orcas Island Pottery", island: "orcas", area: "Eastsound", lat: 48.678, lng: -122.955, walkFromDock: "drive/shuttle", type: "gallery", description: "Oldest pottery in the Pacific Northwest (est. 1945). Whimsical gardens, working artists." },
  { id: "orcas-artworks", name: "Orcas Island Artworks", island: "orcas", area: "Olga", lat: 48.621, lng: -122.833, walkFromDock: "drive", type: "gallery", description: "Cooperative in a 1938 strawberry barreling plant. 45 island artists — pottery, glass, wood, fiber." },
  { id: "crow-valley", name: "Crow Valley Gallery", island: "orcas", area: "Eastsound", lat: 48.692, lng: -122.91, walkFromDock: "drive/shuttle", type: "gallery", description: "Waterfront gallery since 1959." },
  { id: "chimera", name: "Chimera Gallery", island: "lopez", area: "Lopez Village", lat: 48.5152, lng: -122.9005, walkFromDock: "1 mi", type: "gallery", description: "Cooperative (est. 1987) — painting, ceramics, glass, fiber, metalwork." },
  { id: "mohlman", name: "Peter A. Mohlman Fine Arts & Design", island: "orcas", area: "Eastsound", lat: 48.6945, lng: -122.906, walkFromDock: "drive/shuttle", type: "artist_studio", description: "Working artist gallery and teaching studio. Atlanta College of Art-trained, full-time Orcas resident. Watercolor and acrylic landscapes. Classes $50 (3-class min) or $65 individual; scholarships available." },
  { id: "darvills", name: "Darvill's Bookstore", island: "orcas", area: "Eastsound", lat: 48.695, lng: -122.907, walkFromDock: "drive/shuttle", type: "bookstore", description: "Independent bookstore and coffee bar for 35+ years. Batdorf & Bronson and Dancing Goats coffee. Overlooks the Sound. 296 Main Street." }
];
