...
const DINING = [
  ...
  { id: "westcott-bay", name: "Westcott Bay Shellfish Co.", island: "san-juan", area: "Roche Harbor (1mi)", lat: 48.605, lng: -123.16, cuisine: "Oyster Bar", price: "$$", walkFromDock: "1 mi", hours: "May-Oct, reservation-based 1.5-hr seatings", description: "Eat oysters where they grow at beachside picnic tables overlooking cultivated tidelands." },
  ...
  { id: "buck-bay", name: "Buck Bay Shellfish Farm", island: "orcas", area: "Olga", lat: 48.635, lng: -122.855, cuisine: "Oyster Bar", price: "$$", walkFromDock: "2.5 mi from Rosario", hours: null, description: "Ultra-fresh shucked oysters at picnic tables on a working farm." },
...
const GALLERIES = [
  { id: "arctic-raven", name: "Arctic Raven Gallery", island: "san-juan", area: "Friday Harbor", walkFromDock: "0.1 mi", description: "Northwest Coast Native art — masks, carvings, prints from Coast Salish, Haida, and Tlingit nations. 130 First Street S." },
  { id: "waterworks", name: "WaterWorks Gallery", island: "san-juan", area: "Friday Harbor", walkFromDock: "0.2 mi", description: "Contemporary Pacific Northwest artists since 1985." },
  { id: "island-studios", name: "Island Studios", island: "san-juan", area: "Friday Harbor", walkFromDock: "0.3 mi", description: "Exclusively represents artists living in the San Juans. 270 Spring Street." },
  { id: "sji-museum-art", name: "San Juan Islands Museum of Art", island: "san-juan", area: "Friday Harbor", walkFromDock: "0.3 mi", description: "Rotating exhibitions Fri-Mon 11AM-5PM. Administers the Sculpture Park near Roche Harbor. 540 Spring Street." },
  { id: "sculpture-park", name: "San Juan Islands Sculpture Park", island: "san-juan", area: "Roche Harbor", walkFromDock: "Near Roche Harbor", description: "Free 20-acre outdoor park with 150 sculptures across 5 trails. Open dawn to dusk year-round." },
  { id: "orcas-pottery", name: "Orcas Island Pottery", island: "orcas", area: "Eastsound", walkFromDock: "drive/shuttle", description: "Oldest pottery in the Pacific Northwest (est. 1945). Whimsical gardens, working artists." },
  { id: "orcas-artworks", name: "Orcas Island Artworks", island: "orcas", area: "Olga", walkFromDock: "drive", description: "Cooperative in a 1938 strawberry barreling plant. 45 island artists — pottery, glass, wood, fiber." },
  { id: "crow-valley", name: "Crow Valley Gallery", island: "orcas", area: "Eastsound", walkFromDock: "drive/shuttle", description: "Waterfront gallery since 1959." },
  { id: "chimera", name: "Chimera Gallery", island: "lopez", area: "Lopez Village", walkFromDock: "1 mi", description: "Cooperative (est. 1987) — painting, ceramics, glass, fiber, metalwork." }
];
